   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await message.reply_text("You are Banned. Contact -- @satyajeetkumarofficial")
            return 1
        ...
        return 1
         ...
         await message.reply_text("Something Went Wrong. Contact us @satyajeetkumarofficial...")
         return 1
