...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        ...
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/ProBotXUpdate")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/Satyajeetkumarofficial")   
